...
def generate_launch_description():
    config = os.path.join(
    get_package_share_directory('homing_flight'),
    'config',
    'params.yaml'
    )
    ...
    homing_control_node = Node(
        package='homing_flight',  # Replace with your package name
        executable='homing',  # Replace with your node's executable name
        name='homing_control_node',  # Optional: Replace with a custom node name if you wish
